...
say "Забрать к себе — команда для ВАШЕГО компьютера, не для сервера."
say "Точка на конце обязательна, это «положить сюда»:"
say "   scp -r ${SUDO_USER:-$(whoami)}@АДРЕС_СЕРВЕРА:$DEST ."
