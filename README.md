...
Пароля нет. Вход по логину и двум контрольным вопросам, которые пользователь задаёт при регистрации. Ответы хранятся в виде хэшей (scrypt с солью), сравнение без учёта регистра и лишних пробелов. Сессия — случайный токен на 30 дней; попытки входа ограничены по IP.
